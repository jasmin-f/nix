...
{
  description = "Dev Setup für Web Engineering 2, aktuell nutze ich VS Code (Windows Installation) und nodejs `npm`";
  ...
  outputs =
    ...
    inputs.flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        # does not provide attribute 'devShells.x86_64-linux.nodejs'
